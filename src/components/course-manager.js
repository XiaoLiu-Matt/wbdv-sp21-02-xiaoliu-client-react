            ...
            <div>
                ...
                <div>
                    <div className="row">
                        ...
                        />
                        <div className="col-1">
                            <i  onClick={this.addCourse} className="fas fa-plus-circle fa-2x col-1 wbdv-home-red"></i>
                        </div>
                    </div>
                </div>
                ...
                <div className="wbdv-sticky-nav-bar">
                    <i onClick={this.addCourse} className="fas fa-plus-circle fa-4x wbdv-home-red"></i>
                </div>
            </div>
